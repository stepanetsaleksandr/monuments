          ...
          >
            <article>
              ...
              <p>
                ...
                речей, від пам'ятників та оздоблювальних елементів до сходів та
                стільниць. Їх багата кольорова гамма та природні варіації у
                текстурі дозволяють створювати унікальні дизайни та композиції.
                Крім того, граніт може бути оброблений різними способами, такими
                як полірування або шліфування, що дає можливість досягти
                різноманітних ефектів та фінішів.
              </p>
              <p>
              ...
              <p>
                ...
                барельєфи, скульптури та фігури. Пам'ятники з граніту можуть
                бути встановлені на кладовищах, у парках або на площах пам'яті.
              </p>
              <p>
